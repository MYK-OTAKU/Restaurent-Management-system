...
namespace Restaurant_Management_System.View
{
    public partial class TableView : sampleViews
    {
        ...
        {
            // Placez ce code dans l'événement Shown pour garantir qu'il est exécuté après l'affichage de la fenêtre
        ...
        private void guna2DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (guna2DataGridView1.CurrentCell.OwningColumn.Name == "dgvdel")
            {
                ...
                if (MessageBoxGunaYesNo.Show("Êtes-vous sûr de vouloir supprimer cette table", "RMS", MessageBoxType.Question) == DialogResult.Yes)
                {
